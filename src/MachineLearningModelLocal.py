...
def RandomForestRegressor_model(X_train, X_test, y_train, y_test, tree_number = 100):
    rfr = RandomForestRegressor(n_estimators=tree_number, criterion='mse', n_jobs=-1, oob_score=True)
    '''other parameters:
